...
public class BeattheBit extends JFrame {
	...
	private ImageIcon quitButtonEnteredImage	 =new ImageIcon(Main.class.getResource("../images/quitbuttonpressed.png"));// 눌렀을때의시작버튼을 만들어 준다
	
	private ImageIcon quitButtonBasicImage	 =new ImageIcon(Main.class.getResource("../images/quitbutton.png"));// 평상시의 시작버튼을 만들어 준다
	...
	private JButton quitButton = new JButton(quitButtonBasicImage);// 나가기 버튼을 생성하는 객체 생성 
	...
	public BeattheBit() {
		...
		quitButton.setBounds(30,400 , 203, 248);// 나가기 버튼 만들기 위해 위치 지정
